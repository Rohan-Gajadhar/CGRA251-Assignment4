...
Scene Scene::shapeScene() {
	...
	// YOUR CODE GOES HERE
    objects.push_back(make_shared<SceneObject>(make_shared<Plane>(vec3(1, -2, -5), vec3(0.0, -0.1, 0.0)), white));
    objects.push_back(make_shared<SceneObject>(make_shared<Disk>(vec3(0.75, 0, -5), vec3(3, 0, -0.8), 1.2), white));
